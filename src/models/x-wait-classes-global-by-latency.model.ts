...
@model({
  settings: {
    idInjection: false,
    mysql: {schema: 'sys', table: 'x$wait_classes_global_by_latency'}
  }
})
export class XWaitClassesGlobalByLatency extends Entity {
  @property({
    type: 'string',
    length: 128,
  ...
  constructor(data?: Partial<XWaitClassesGlobalByLatency>) {
    super(data);
  }
}

export interface XWaitClassesGlobalByLatencyRelations {
  // describe navigational properties here
}

export type XWaitClassesGlobalByLatencyWithRelations = XWaitClassesGlobalByLatency & XWaitClassesGlobalByLatencyRelations;
