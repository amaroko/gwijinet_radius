...
@model({
  settings: {idInjection: false, mysql: {schema: 'sys', table: 'user_summary_by_stages'}}
})
export class UserSummaryByStages extends Entity {
  @property({
    type: 'string',
    length: 128,
  ...
  constructor(data?: Partial<UserSummaryByStages>) {
    super(data);
  }
}

export interface UserSummaryByStagesRelations {
  // describe navigational properties here
}

export type UserSummaryByStagesWithRelations = UserSummaryByStages & UserSummaryByStagesRelations;
