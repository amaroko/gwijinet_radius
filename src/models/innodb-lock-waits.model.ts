...
@model({
  settings: {idInjection: false, mysql: {schema: 'sys', table: 'innodb_lock_waits'}}
})
export class InnodbLockWaits extends Entity {
  @property({
    type: 'date',
  ...
  @property({
    type: 'string',
    length: 4294967295,
    mysql: {columnName: 'blocking_query', dataType: 'longtext', dataLength: 4294967295, dataPrecision: null, dataScale: null, nullable: 'Y'},
  })
  ...
  constructor(data?: Partial<InnodbLockWaits>) {
    super(data);
  }
}

export interface InnodbLockWaitsRelations {
  // describe navigational properties here
}

export type InnodbLockWaitsWithRelations = InnodbLockWaits & InnodbLockWaitsRelations;
