...
@model({
  settings: {idInjection: false, mysql: {schema: 'sys', table: 'waits_by_host_by_latency'}}
})
export class WaitsByHostByLatency extends Entity {
  @property({
    type: 'string',
    length: 255,
  ...
  constructor(data?: Partial<WaitsByHostByLatency>) {
    super(data);
  }
}

export interface WaitsByHostByLatencyRelations {
  // describe navigational properties here
}

export type WaitsByHostByLatencyWithRelations = WaitsByHostByLatency & WaitsByHostByLatencyRelations;
