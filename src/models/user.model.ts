...
export class User extends Entity {
  @property({
    ...
    required: true,
    length: 255,
    mysql: {columnName: 'Host', dataType: 'char', dataLength: 255, dataPrecision: null, dataScale: null, nullable: 'N'},
  })
  host: string;
  ...
  @property({
    ...
    required: true,
    length: 128,
    mysql: {columnName: 'User', dataType: 'char', dataLength: 128, dataPrecision: null, dataScale: null, nullable: 'N'},
  })
  user: string;
