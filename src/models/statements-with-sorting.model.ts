...
@model({
  settings: {idInjection: false, mysql: {schema: 'sys', table: 'statements_with_sorting'}}
})
export class StatementsWithSorting extends Entity {
  @property({
    type: 'string',
    length: 4294967295,
  ...
  constructor(data?: Partial<StatementsWithSorting>) {
    super(data);
  }
}

export interface StatementsWithSortingRelations {
  // describe navigational properties here
}

export type StatementsWithSortingWithRelations = StatementsWithSorting & StatementsWithSortingRelations;
