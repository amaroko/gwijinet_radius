...
@model({
  settings: {
    idInjection: false,
    mysql: {schema: 'sys', table: 'x$innodb_buffer_stats_by_table'}
  }
})
export class XInnodbBufferStatsByTable extends Entity {
  @property({
    type: 'string',
    length: 65535,
  ...
  @property({
    type: 'string',
    length: 65535,
    mysql: {columnName: 'object_name', dataType: 'text', dataLength: 65535, dataPrecision: null, dataScale: null, nullable: 'Y'},
  })
  objectName?: string;
  ...
  constructor(data?: Partial<XInnodbBufferStatsByTable>) {
    super(data);
  }
}

export interface XInnodbBufferStatsByTableRelations {
  // describe navigational properties here
}

export type XInnodbBufferStatsByTableWithRelations = XInnodbBufferStatsByTable & XInnodbBufferStatsByTableRelations;
