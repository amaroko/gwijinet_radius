...
@model({
  settings: {
    idInjection: false,
    mysql: {schema: 'sys', table: 'innodb_buffer_stats_by_table'}
  }
})
export class InnodbBufferStatsByTable extends Entity {
  @property({
    type: 'string',
    length: 65535,
  ...
  constructor(data?: Partial<InnodbBufferStatsByTable>) {
    super(data);
  }
}

export interface InnodbBufferStatsByTableRelations {
  // describe navigational properties here
}

export type InnodbBufferStatsByTableWithRelations = InnodbBufferStatsByTable & InnodbBufferStatsByTableRelations;
