...
@model({
  settings: {
    idInjection: false,
    mysql: {schema: 'sys', table: 'user_summary_by_file_io_type'}
  }
})
export class UserSummaryByFileIoType extends Entity {
  @property({
    type: 'string',
    length: 128,
  ...
  constructor(data?: Partial<UserSummaryByFileIoType>) {
    super(data);
  }
}

export interface UserSummaryByFileIoTypeRelations {
  // describe navigational properties here
}

export type UserSummaryByFileIoTypeWithRelations = UserSummaryByFileIoType & UserSummaryByFileIoTypeRelations;
