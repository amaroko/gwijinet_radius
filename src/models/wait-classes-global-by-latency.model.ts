...
@model({
  settings: {
    idInjection: false,
    mysql: {schema: 'sys', table: 'wait_classes_global_by_latency'}
  }
})
export class WaitClassesGlobalByLatency extends Entity {
  @property({
    type: 'string',
    length: 128,
  ...
  constructor(data?: Partial<WaitClassesGlobalByLatency>) {
    super(data);
  }
}

export interface WaitClassesGlobalByLatencyRelations {
  // describe navigational properties here
}

export type WaitClassesGlobalByLatencyWithRelations = WaitClassesGlobalByLatency & WaitClassesGlobalByLatencyRelations;
