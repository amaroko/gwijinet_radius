...
@model({
  settings: {
    idInjection: false,
    mysql: {schema: 'sys', table: 'statements_with_runtimes_in_95th_percentile'}
  }
})
export class StatementsWithRuntimesIn_95thPercentile extends Entity {
  @property({
    type: 'string',
    length: 4294967295,
  ...
  constructor(data?: Partial<StatementsWithRuntimesIn_95thPercentile>) {
    super(data);
  }
}

export interface StatementsWithRuntimesIn_95thPercentileRelations {
  // describe navigational properties here
}

export type StatementsWithRuntimesIn_95thPercentileWithRelations = StatementsWithRuntimesIn_95thPercentile & StatementsWithRuntimesIn_95thPercentileRelations;
