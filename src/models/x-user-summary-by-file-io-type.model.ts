...
@model({
  settings: {
    idInjection: false,
    mysql: {schema: 'sys', table: 'x$user_summary_by_file_io_type'}
  }
})
export class XUserSummaryByFileIoType extends Entity {
  @property({
    type: 'string',
    length: 128,
  ...
  constructor(data?: Partial<XUserSummaryByFileIoType>) {
    super(data);
  }
}

export interface XUserSummaryByFileIoTypeRelations {
  // describe navigational properties here
}

export type XUserSummaryByFileIoTypeWithRelations = XUserSummaryByFileIoType & XUserSummaryByFileIoTypeRelations;
