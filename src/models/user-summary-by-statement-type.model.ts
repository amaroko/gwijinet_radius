...
@model({
  settings: {
    idInjection: false,
    mysql: {schema: 'sys', table: 'user_summary_by_statement_type'}
  }
})
export class UserSummaryByStatementType extends Entity {
  @property({
    type: 'string',
    length: 128,
  ...
  constructor(data?: Partial<UserSummaryByStatementType>) {
    super(data);
  }
}

export interface UserSummaryByStatementTypeRelations {
  // describe navigational properties here
}

export type UserSummaryByStatementTypeWithRelations = UserSummaryByStatementType & UserSummaryByStatementTypeRelations;
