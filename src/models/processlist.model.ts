...
@model({settings: {idInjection: false, mysql: {schema: 'sys', table: 'processlist'}}})
export class Processlist extends Entity {
  @property({
    type: 'number',
    required: true,
    precision: 20,
  ...
  constructor(data?: Partial<Processlist>) {
    super(data);
  }
}

export interface ProcesslistRelations {
  // describe navigational properties here
}

export type ProcesslistWithRelations = Processlist & ProcesslistRelations;
