...
@model({
  settings: {idInjection: false, mysql: {schema: 'sys', table: 'statement_analysis'}}
})
export class StatementAnalysis extends Entity {
  @property({
    type: 'string',
    length: 4294967295,
  ...
  constructor(data?: Partial<StatementAnalysis>) {
    super(data);
  }
}

export interface StatementAnalysisRelations {
  // describe navigational properties here
}

export type StatementAnalysisWithRelations = StatementAnalysis & StatementAnalysisRelations;
