...
@model({settings: {idInjection: false, mysql: {schema: 'sys', table: 'x$processlist'}}})
export class XProcesslist extends Entity {
  @property({
    type: 'number',
    required: true,
    precision: 20,
  ...
  constructor(data?: Partial<XProcesslist>) {
    super(data);
  }
}

export interface XProcesslistRelations {
  // describe navigational properties here
}

export type XProcesslistWithRelations = XProcesslist & XProcesslistRelations;
