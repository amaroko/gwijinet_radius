...
@model({
  settings: {idInjection: false, mysql: {schema: 'sys', table: 'waits_by_user_by_latency'}}
})
export class WaitsByUserByLatency extends Entity {
  @property({
    type: 'string',
    length: 128,
  ...
  constructor(data?: Partial<WaitsByUserByLatency>) {
    super(data);
  }
}

export interface WaitsByUserByLatencyRelations {
  // describe navigational properties here
}

export type WaitsByUserByLatencyWithRelations = WaitsByUserByLatency & WaitsByUserByLatencyRelations;
