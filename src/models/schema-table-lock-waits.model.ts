...
@model({
  settings: {idInjection: false, mysql: {schema: 'sys', table: 'schema_table_lock_waits'}}
})
export class SchemaTableLockWaits extends Entity {
  @property({
    type: 'string',
    length: 64,
  ...
  constructor(data?: Partial<SchemaTableLockWaits>) {
    super(data);
  }
}

export interface SchemaTableLockWaitsRelations {
  // describe navigational properties here
}

export type SchemaTableLockWaitsWithRelations = SchemaTableLockWaits & SchemaTableLockWaitsRelations;
