...
@model({
  settings: {
    idInjection: false,
    mysql: {schema: 'sys', table: 'io_global_by_wait_by_latency'}
  }
})
export class IoGlobalByWaitByLatency extends Entity {
  @property({
    type: 'string',
    length: 128,
  ...
  constructor(data?: Partial<IoGlobalByWaitByLatency>) {
    super(data);
  }
}

export interface IoGlobalByWaitByLatencyRelations {
  // describe navigational properties here
}

export type IoGlobalByWaitByLatencyWithRelations = IoGlobalByWaitByLatency & IoGlobalByWaitByLatencyRelations;
