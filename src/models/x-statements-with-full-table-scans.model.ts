...
@model({
  settings: {
    idInjection: false,
    mysql: {schema: 'sys', table: 'x$statements_with_full_table_scans'}
  }
})
export class XStatementsWithFullTableScans extends Entity {
  @property({
    type: 'string',
    length: 4294967295,
  ...
  constructor(data?: Partial<XStatementsWithFullTableScans>) {
    super(data);
  }
}

export interface XStatementsWithFullTableScansRelations {
  // describe navigational properties here
}

export type XStatementsWithFullTableScansWithRelations = XStatementsWithFullTableScans & XStatementsWithFullTableScansRelations;
