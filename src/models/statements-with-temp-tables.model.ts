...
@model({
  settings: {
    idInjection: false,
    mysql: {schema: 'sys', table: 'statements_with_temp_tables'}
  }
})
export class StatementsWithTempTables extends Entity {
  @property({
    type: 'string',
    length: 4294967295,
  ...
  constructor(data?: Partial<StatementsWithTempTables>) {
    super(data);
  }
}

export interface StatementsWithTempTablesRelations {
  // describe navigational properties here
}

export type StatementsWithTempTablesWithRelations = StatementsWithTempTables & StatementsWithTempTablesRelations;
