...
@model({
  settings: {
    idInjection: false,
    mysql: {schema: 'sys', table: 'statements_with_errors_or_warnings'}
  }
})
export class StatementsWithErrorsOrWarnings extends Entity {
  @property({
    type: 'string',
    length: 4294967295,
  ...
  constructor(data?: Partial<StatementsWithErrorsOrWarnings>) {
    super(data);
  }
}

export interface StatementsWithErrorsOrWarningsRelations {
  // describe navigational properties here
}

export type StatementsWithErrorsOrWarningsWithRelations = StatementsWithErrorsOrWarnings & StatementsWithErrorsOrWarningsRelations;
